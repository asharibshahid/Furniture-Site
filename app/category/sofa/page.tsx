...
import { Sofas } from "@/sanity/lib/queries";
...
// This is a Server Component in the app directory, where we fetch data directly
export default async function FurnitureCard() {
  // Fetch the data from Sanity CMS
  const Data: FurnitureItem[] = await SanityFetch({ query: Sofas });
...
export async function generateMetadata() {
  // Revalidate after every 60 seconds
  return {
    revalidate: 60, // Set revalidation for this page
  };
}